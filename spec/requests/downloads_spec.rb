...
RSpec.describe 'Downloads', type: :request do
  ...
  let!(:show) { Show.create!(ohdio_id: 123, title: 'Show', ohdio_type: 'emission_premiere') }
  let!(:episode) { show.episodes.create!(ohdio_episode_id: 'ep-2', is_replay: false, position: 1, page_number: 1) }

  it 'downloads a merged episode mp3 when media is resolved' do
    medium_one = Medium.create!(media_id: 'm1', audio_url: 'https://cdn.example.com/part-1.mp3', resolved: true, resolved_at: Time.current)
    medium_two = Medium.create!(media_id: 'm2', audio_url: 'https://cdn.example.com/part-2.mp3', resolved: true, resolved_at: Time.current)
    episode.segments.create!(media_id: medium_one.media_id, position: 1)
    episode.segments.create!(media_id: medium_two.media_id, position: 2)
  ...
  it 'downloads a single clipped segment when segment_query is present' do
    ...
    medium_one = Medium.create!(media_id: 'm1', audio_url: 'https://cdn.example.com/part-1.mp3', resolved: true, resolved_at: Time.current)
    medium_two = Medium.create!(media_id: 'm2', audio_url: 'https://cdn.example.com/part-2.mp3', resolved: true, resolved_at: Time.current)
    segment = episode.segments.create!(title: 'bloc politique', media_id: medium_one.media_id, seek_time: 10, duration: 30, position: 1)
    episode.segments.create!(title: 'bloc culture', media_id: medium_two.media_id, seek_time: 20, duration: 45, position: 2)
  ...
  it 'returns 404 when segment_query excludes all valid segments' do
    feed.update!(segment_query: 'politique')
    medium_one = Medium.create!(media_id: 'm1', audio_url: 'https://cdn.example.com/part-1.mp3', resolved: true, resolved_at: Time.current)
    segment = episode.segments.create!(title: 'bloc culture', media_id: medium_one.media_id, seek_time: 10, duration: 30, position: 1)
  ...
  it 'returns 404 on episode download when segment_query is present' do
    feed.update!(segment_query: 'politique')
    medium_one = Medium.create!(media_id: 'm1', audio_url: 'https://cdn.example.com/part-1.mp3', resolved: true, resolved_at: Time.current)
    episode.segments.create!(title: 'bloc politique', media_id: medium_one.media_id, seek_time: 10, duration: 30, position: 1)
  ...
  it 'returns 202 when segment media is unresolved' do
    Medium.create!(media_id: 'm1', resolved: false)
    episode.segments.create!(media_id: 'm1', position: 1)
  ...
  it 'returns 404 when episode exceeds feed max_episodes' do
    ...
    older_episode = show.episodes.create!(ohdio_episode_id: 'ep-older', is_replay: false, position: 2, page_number: 1)
    medium = Medium.create!(media_id: 'm4', audio_url: 'https://cdn.example.com/older.mp3', resolved: true, resolved_at: Time.current)
    older_episode.segments.create!(media_id: medium.media_id, position: 1)
  ...
  it 'returns 404 when episode is excluded by feed query' do
    ...
    filtered_episode = show.episodes.create!(ohdio_episode_id: 'ep-filtered', is_replay: false, position: 2, page_number: 1)
    medium = Medium.create!(media_id: 'm5', audio_url: 'https://cdn.example.com/filtered.mp3', resolved: true, resolved_at: Time.current)
    filtered_episode.segments.create!(media_id: medium.media_id, position: 1)
  ...
  it 'returns 404 for replay episode by default' do
    replay = show.episodes.create!(ohdio_episode_id: 'ep-replay', is_replay: true, position: 2, page_number: 1)
    replay.segments.create!(media_id: 'm1', position: 1)
  ...
  it 'allows replay episode download when exclude_replays is disabled' do
    ...
    replay = show.episodes.create!(ohdio_episode_id: 'ep-replay', is_replay: true, position: 2, page_number: 1)
    medium = Medium.create!(media_id: 'm3', audio_url: 'https://cdn.example.com/replay.mp3', resolved: true, resolved_at: Time.current)
    replay.segments.create!(media_id: medium.media_id, position: 1)
