...
RSpec.describe OhdioRssBuilder do
  ...
  it 'builds emission_premiere RSS with merged mp3 enclosures' do
    show = Show.create!(ohdio_id: 1, title: 'My Show', description: 'Show description', ohdio_type: 'emission_premiere')
    ...
    feed = Feed.create!(name: 'Test Feed', show_id: 1)
  ...
  it 'builds non-emission RSS items with direct audio URLs' do
    show = Show.create!(ohdio_id: 2, title: 'My Podcast', description: 'Podcast description', ohdio_type: 'balado')
    ...
    feed = Feed.create!(name: 'Test Feed', show_id: 2)
  ...
  it 'filters replay episodes when feed excludes replays' do
    show = Show.create!(ohdio_id: 3, title: 'My Show', description: 'Show description', ohdio_type: 'emission_premiere')
    ...
    medium = Medium.create!(media_id: 'm9', audio_url: 'https://cdn.example.com/replay.mp3', resolved: true, resolved_at: Time.current)
    replay.segments.create!(media_id: medium.media_id, duration: 30, position: 1)

    feed = Feed.create!(name: 'Test Feed', show_id: 3)
  ...
  it 'limits RSS items to feed max_episodes' do
    show = Show.create!(ohdio_id: 4, title: 'Limited Show', description: 'Show description', ohdio_type: 'balado')
    show.episodes.create!(
      ohdio_episode_id: 'ep-1',
    ...
    feed = Feed.create!(name: 'Test Feed', show_id: 4, max_episodes: 1)
  ...
  it 'strips numeric episode prefix in RSS item titles' do
    show = Show.create!(ohdio_id: 5, title: 'Prefix Show', description: 'Show description', ohdio_type: 'balado')
    show.episodes.create!(
      ohdio_episode_id: 'ep-1',
    ...
    feed = Feed.create!(name: 'Test Feed', show_id: 5)
  ...
  it 'strips html tags in RSS item titles' do
    show = Show.create!(ohdio_id: 6, title: 'HTML Prefix Show', description: 'Show description', ohdio_type: 'balado')
    show.episodes.create!(
      ohdio_episode_id: 'ep-1',
    ...
    feed = Feed.create!(name: 'Test Feed', show_id: 6)
  ...
  it 'emits one RSS item per matching segment when segment_query is set' do
    show = Show.create!(ohdio_id: 7, title: 'Segment Show', description: 'Show description', ohdio_type: 'emission_premiere')
    episode = show.episodes.create!(
      ohdio_episode_id: 'ep-1',
    ...
    matching_medium = Medium.create!(media_id: 'm1', audio_url: 'https://cdn.example.com/segment-1.mp3', resolved: true, resolved_at: Time.current)
    skipped_medium = Medium.create!(media_id: 'm2', audio_url: 'https://cdn.example.com/segment-2.mp3', resolved: true, resolved_at: Time.current)
    matching_segment = episode.segments.create!(title: 'bloc politique', duration: 30, seek_time: 0, media_id: matching_medium.media_id, position: 1)
    episode.segments.create!(title: 'bloc culture', duration: 30, seek_time: 0, media_id: skipped_medium.media_id, position: 2)

    feed = Feed.create!(name: 'Test Feed', show_id: 7, segment_query: 'politique')
